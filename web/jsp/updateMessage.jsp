                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="compose-mail">
                                <form role="form-horizontal" method="post" action="/message/update">
                                    <div class="form-group">
                                        <label for="subject" class="">描述:</label>
                                        <input type="text" tabindex="1" id="subject" name="description" class="form-control" value="${note.description}">
                                    </div>
