                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body minimal">
                            <div class="mail-option">
                                ...
                                <div class="btn-group">
                                    <a data-original-title="add" href="${pageContext.request.contextPath}/jsp/insertDraft.jsp" class="btn mini tooltips">
                                        +
                                    </a>
                                </div>
                                <div class="btn-group">
                                    <a data-original-title="Refresh" href="/message/selectAll" class="btn mini tooltips">
                            ...
                            <div class="table-inbox-wrap ">
                                <table class="table table-inbox table-hover">
                                    ...
                                    <tr class="unread">
                                        ...
                                        <td class="inbox-small-cells">草稿</td>
                                    ...
                                    <c:forEach var="note" items="${AllMessage}">
                                        <tr class="unread">
                                            ...
                                            <td class="view-message  dont-show"><a href="/message/selectDraft?id=${note.id}">${note.user.name}</a></td>
                                            <td class="view-message "><a href="/message/selectDraft?id=${note.id}">${note.description}</a></td>

                                            <td class="view-message  inbox-small-cells"><i class="fa fa-paperclip"></i></td>
                                            <div class="pull-right hidden-phone">
                                                <td class="view-message  text-right"><a  href="/message/deleteDraft?id=${note.id}" class="btn btn-danger btn-xs" style="color: whitesmoke"><i class="fa fa-trash-o "></i></a></td>
