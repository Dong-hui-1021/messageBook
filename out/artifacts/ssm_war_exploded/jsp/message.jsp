                        ...
                        <div class="panel-body ">
                            ...
                            <div class="mail-sender">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <p class="date">Last update:${message.updateTime}</p>
                                    </div>
                                </div>
                            </div>
                            <div class="view-mail">
                            ...
                            <div class="compose-btn pull-left">
                                <a href="/message/updateSelect?id=${message.id}"><button class="btn btn-sm "><i class="fa fa-arrow-right"/></i> Update</button></a>
                            </div>
                            </c:if>
                        </div>
                    </section>
