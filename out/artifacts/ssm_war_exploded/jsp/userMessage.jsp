                ...
                <div class="col-sm-9">
                    <section class="panel">
                        <header class="panel-heading wht-bg">
                            <h4 class="gen-case">
                                Welcome Write Down Your Whispers!
                            </h4>
                        </header>
                            ...
                            <div class="table-inbox-wrap ">
                                <table class="table table-inbox table-hover">
                                    ...
                                    <tr class="unread">
                                        ...
                                        <td class="view-message  text-right">修改时间</td>
                                    ...
                                    <c:forEach var="note" items="${AllMessage}">
                                        <tr class="unread">
                                            ...
                                            <td class="view-message  dont-show"><a href="/message/selectOnce?id=${note.id}">${note.user.name}</a></td>
                                            ...
                                            <div class="pull-right hidden-phone">
                                                <td class="view-message  text-right"><a  href="/message/deleteMessage?id=${note.id}" class="btn btn-danger btn-xs" style="color: whitesmoke"><i class="fa fa-trash-o "></i></a></td>
