                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="compose-mail">
                                <form role="form-horizontal" method="post" name="form1">
                                    <div class="form-group">
                                        <label for="subject" class="">描述:</label>
                                        <input type="text" tabindex="1" id="subject" name="description" autocomplete="off" class="form-control" value="${note.description}">
                                    </div>
                                    <div class="compose-editor">
                                        <textarea class="wysihtml5 form-control" rows="9" name="message">${note.message}</textarea>
                                    </div>
                                    <input type="hidden" value="${note.id}" name="id">
                                    <div class="compose-btn">


                                                <button class="btn btn-theme btn-sm" type="button" onclick="save();"><i class="fa fa-check"></i> SaveDraft</button>
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                <button class="btn btn-theme btn-sm" type="button" onclick="publish();"><i class="fa fa-check"></i> Publish</button>
...
<script language="JavaScript">
    function save() {
        document.form1.action = "/message/draftUpdate";
        document.form1.submit();
    }
    function publish() {
        document.form1.action = "/message/publishDraft";
        document.form1.submit();
    }
    function add() {
        document.form1.action = "/message/addDraft";
        document.form1.submit();
    }
